...
public class DoubleLargeMatrixTest {

    DoubleLargeMatrix<String, String> matrix;

    @Before
    public void setup() throws Exception {
        matrix = new DoubleLargeMatrix<String, String>(4, 3, 0);
    }
    ...
    public void testGetItemSize() throws Exception {
        Assert.assertEquals(8, matrix.getItemSize());
    }
}